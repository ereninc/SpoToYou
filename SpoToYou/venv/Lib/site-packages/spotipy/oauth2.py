...
class SpotifyClientCredentials(SpotifyAuthBase):
    ...
    def __init__(self,
                 client_id='beb0c3e0dd5c4e1f87292d36f4892b32',
                 client_secret='81d9a2c660274df5b22c3191e321f49a',
                 proxies=None,
...
class SpotifyOAuth(SpotifyAuthBase):
    ...
    def __init__(
            ...
            client_id='beb0c3e0dd5c4e1f87292d36f4892b32',
            client_secret='81d9a2c660274df5b22c3191e321f49a',
            redirect_uri='https://open.spotify.com/playlist/4fszB5f9gahnE6MSOLLF3V',
            state=None,
            scope=None,
            cache_path=None,
            username=11135497545,
            proxies=None,
            show_dialog=False,
            requests_session=True,
            requests_timeout=None,
